...
import { LogIn, Mail, Lock, Eye, EyeOff, Video } from "lucide-react";
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-4 p-3 rounded-lg bg-zinc-700/30 border border-zinc-600/50">
              <p className="text-xs text-zinc-500 text-center">
                Demo: <span className="text-zinc-300">demo@test.com</span> / <span className="text-zinc-300">password123</span>
              </p>
            </div>
          </CardContent>
        </Card>
